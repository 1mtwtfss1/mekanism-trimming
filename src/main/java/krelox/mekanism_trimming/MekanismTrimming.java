package krelox.mekanism_trimming;
...
@Mod(MekanismTrimming.MOD_ID)
public class MekanismTrimming {
    public static final String MOD_ID = "mekanism_trimming";

    public MekanismTrimming(IEventBus modEventBus) {
